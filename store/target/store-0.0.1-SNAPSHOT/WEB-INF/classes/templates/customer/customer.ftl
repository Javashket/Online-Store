        ...
        <div class="row">
                ...
                <div class="row page-content content-grid">
                    ...
                    <div class="col-md-3 content-item mt-2 mb-2">
                        <div class="card" style="width: 195px;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-center"><a href="/product_customer${product.id}" class="item_title">${product.name}</a></h5>
            ...
            <aside class="col-lg-3 order-lg-1 sidebar">
                <div class="container-fluid sidebar-filter">
                    <a href="/search" class="btn btn-primary ml-2 mr-2 mt-2 mb-2 search_button">Поиск</a>
