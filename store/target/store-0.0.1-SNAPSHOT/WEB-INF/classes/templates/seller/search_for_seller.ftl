...
<header>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/seller">Online Clothing Store</a>
            <ul class="navbar-nav">
                <li class="nav-item">
...
<section class="search_field">
    <div class="container">
    <form action="/search_for_seller" method="get">
        ...
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline1" name="search" value="name" class="custom-control-input"
                   <#if search?? && search == "name" >checked </#if>>
            <label class="custom-control-label" for="customRadioInline1">Поиск по названию</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline2" name="search" value="description" class="custom-control-input"
                   <#if search?? && search == "description" >checked </#if>>
